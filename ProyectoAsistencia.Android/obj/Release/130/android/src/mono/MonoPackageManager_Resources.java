...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ProyectoAsistencia.Android.dll" comes first in this list. */
		"ProyectoAsistencia.Android.dll",
		"Acr.UserDialogs.dll",
		"ClosedXML.dll",
		...
		"FontAwesome.Solid.dll",
		"FormsViewGroup.dll",
		"IconFontHelper.dll",
		"ProyectoAsistencia.dll",
		"RBush.dll",
		"Renci.SshNet.Abstractions.dll",
